...
class Transformer(tf.keras.Model):
    def __init__(self, vocab_size, seq_in_length, seq_out_length, embed_dim=128, dense_dim=128, num_heads=4):
        super().__init__()
        ...
        self.seq_in_length = seq_in_length
        self.seq_out_length = seq_out_length - 1
